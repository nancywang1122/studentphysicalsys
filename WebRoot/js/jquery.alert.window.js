function alertWin(title, msg, w, h) {
	...
	bgObj.style.cssText = "position:absolute;left:0px;top:0px;width:"
			...
			+ "px;filter:Alpha(Opacity=80);opacity:0.3;background-color:#000000;z-index:100;";
	...
	mask.scrolling = "no";
	mask.frameborder = "0";
	mask.style.cssText = "position:absolute;z-index:" + msgObj.style.zIndex - 1
			+ ";top:" + msgObj.style.top + ";left:" + msgObj.style.left
			+ ";width:" + msgObj.style.width + ";height:" + msgObj.style.height
			+ ";";
	...
	addEvent(msgObj, "selectstart", function() {
		return false;
	});
	...
	function mousedown() {
		...
		window.onresize = function() {
			...
			bgObj.style.height = documes3Qnt.documentElement.clientHeight
					+ "px";
		}
		if (getBrowser() == "IE")
			msgObj.setCapture();
