		...
		<div class="top">
			<div class="logo_bg">
				<img src="<rootPath:rootPath/>/frontstage/images/logo.jpg"
					...
					src="<rootPath:rootPath/>/frontstage/images/logo_bg2.gif" width="502" height="100"
					style="float: right;">
				<div class="clear"></div>
			</div>
			<div class="muen">
				...
				<div class="sousuo">
					<input name="" type="text" class="input" value="站内搜索"> <input
						...
						src="<rootPath:rootPath/>/frontstage/<rootPath:rootPath/>/frontstage/images/fangda.gif" style="float: left; margin: 0 8px;">
			...
			<div class="left">
				<div class="banner">
					<div align="center">
						...
						<DIV id=nav>
							<UL>
								<LI><IMG src="<rootPath:rootPath/>/frontstage/images/01.jpg" text="健全的法律制度是现代社会的基石|陆欣律师事务所"
									pic="1">
									<DIV>一个海岛</DIV></LI>
 ...
 //-->
				...
				<div class="zaixian" style="margin-top: 269px;">
					<div class="title_top">
						...
						<a href="http://www.865171.cn"><img src="<rootPath:rootPath/>/frontstage/images/more2.gif"
							border="0"></a>
						<div class="clear"></div>
					</div>
			...
			<div class="right">
				<div class="yewulingyu">
					 <div id="calendar_id" class="easyui-window" title="当前日期" style="float:right; margin-top:4px;">
				...
				<div class="tu_1">
					<img src="<rootPath:rootPath/>/frontstage/images/tu_1.gif" border="0">
				</div>
				<div class="youqing">
				...
				<div class="clear"></div>
				<div class="tu_1">
					<img src="<rootPath:rootPath/>/frontstage/images/tu_2.gif" width="295" height="51" border="0">
				</div>
				<div class="dongtai">
