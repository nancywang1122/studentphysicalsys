...
<body>
	<div class="juzhong">
  <div class="top">
    <div class="top_top"><span style="float:left; margin-left:14px;">欢迎访问某律师团队专业法律服务网！ 建站咨询热线: 15886674344</span><span style="float:right; margin-right:6px;">今天是: 2008.10.22. 星期三</span>
      <div class="clear"></div>
    </div>
    <div class="logo_bg"><img src="<rootPath:rootPath/>/frontstage/images/logo.jpg" style="float:left; margin:18px 0 0 25px;" width="420" height="64"><img src="<rootPath:rootPath/>/frontstage/images/logo_bg2.gif" width="502" height="100"  style=" float:right;">
      <div class="clear"></div>
    </div>
    <div class="muen">
      <div class="subnav">
    ...
    <div class="left">
      <div class="banner">
        <div align="center">
          ...
          <DIV id=nav>
            <UL>
              <LI><IMG src="<rootPath:rootPath/>/frontstage/images/01.jpg" text="健全的法律制度是现代社会的基石|陆欣律师事务所" pic="1">
                <DIV>一个海岛</DIV>
              </LI>
              <LI><IMG src="<rootPath:rootPath/>/frontstage/images/02.jpg" text="美景如画的海景|天蓝海蓝" pic="2">
                <DIV>一片麦穗</DIV>
              </LI>
              <LI><IMG src="<rootPath:rootPath/>/frontstage/images/03.jpg" text="郁郁葱葱的生命|生生不息的生命" pic="3">
                <DIV>一树绿叶</DIV>
              </LI>
              <LI><IMG src="<rootPath:rootPath/>/frontstage/images/04.jpg" text="孤独的一棵老树|等谁呢？" pic="4">
                <DIV>一棵大树</DIV>
              </LI>
              <LI><IMG src="<rootPath:rootPath/>/frontstage/images/05.jpg" text="明媚的向日葵花|生生不息的生命" pic="5">
                <DIV>一地葵花</DIV>
              </LI>
            </UL>
            <DIV id=BG></DIV>
 ...
 //-->
      ...
      <div class="zaixian" style="margin-top:269px;">
        <div class="title_top">
          ...
          <a href="http://www.865171.cn"><img src="<rootPath:rootPath/>/frontstage/images/more2.gif" border="0"></a>
          <div class="clear"></div>
        </div>
      ...
      <div class="jianjie" style="margin-top:269px;">
        ...
        <div class="jianjie_nr">
          <div class="xuxian_bottom" style="padding:16px 0;"> <img src="<rootPath:rootPath/>/frontstage/images/tu_1.jpg"><span>欲修其身者，先正其心，欲正其心者，先
            诚其意。意诚而后心正。“健全的法律制度是
            现代社会的基石”。</span>
            <div class="clear"></div>
          </div>
          <div style=" margin-top:6px;"> 作为一个普通的律师，以为人提供高质、高效的法律服务
            为自己的事业。我渴望看到当事人感谢的眼神，感谢的声
            音，都是对自己辛勤劳动的肯定和对自己存在价值的认可。 </div>
        </div>
      </div>
      <div class="clear"></div>
    </div>
    <div class="right">
      ...
      <div class="clear"></div>
      <div class="tu_1"><img src="<rootPath:rootPath/>/frontstage/images/tu_2.gif" width="295" height="51" border="0"></div>
      <div class="dongtai">
        <div class="dongtai_top_left">网站动态</div>
        <div class="dongtai_top_right"><a href="http://www.865171.cn"><img src="<rootPath:rootPath/>/frontstage/images/more2.gif" border="0"></a></div>
        <div class="clear"></div>
        <div class="dongtai_nr"> <a href="http://www.865171.cn">京都律师事务所2007年大事记回顾</a><br>
          <a href="http://www.865171.cn">我所田文昌律师赴澳门科技大学讲学…</a><br>
          <a href="http://www.865171.cn">陈登富涉嫌贪污行贿、挪用公款一案开庭… </a></div>
      </div>
    </div>
    <div class="clear"></div>
  </div>
  <div class="bottom">
    <div class="bottom_left"> <a href="http://www.865171.cn">联系我们</a> | <a href="http://www.865171.cn">在线咨询</a> | <a href="http://www.865171.cn">网站地图</a> | <a href="http://www.865171.cn">官方博客</a> | <a href="http://www.865171.cn">隐私声明</a> </div>
