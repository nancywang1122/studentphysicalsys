...
keel.UploadPanel = function(cfg){
	...
	keel.UploadPanel.superclass.constructor.call(this,{				
		tbar : [
			...
			{xtype : 'label',text:'队列中文件个数:0',id:'queue_id',scope:this},'-'
		],
		/**
		 * bbar:[
		{xtype:"progress",id:"progressBar",text:"0%",width:200},
...
Ext.extend(keel.UploadPanel,Ext.Panel,{
	...
	formatDelBtn : function(v){
		return "<a href='#' id='"+v+"'  style='color:blue' class='link-btn' ext:qtip='移除该文件'><img src='image/icons/delete.gif'/></a>";
	},
