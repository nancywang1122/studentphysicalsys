...
<!--
	...
	$("li img").load(function() {
		...
		if (num == 4) {
			...
			$("li img.active").fadeTo(200,0.6).removeClass("active").animate({
				top : 5,
				width : 70,
				left : 1
			}, 300)
						...
						$("#back")
								...
								.fadeTo(
										...
										function() {
											//var IMG = new Image();
											//IMG.s
											$(this).children("img").attr("src","<rootPath:rootPath/>/frontstage/images/images/"+ i+ ".jpg")
													.removeClass("gray"); //更改图片
											$(this).fadeTo(500,
															1,
															function() {
																$("#frontText").html(t[0]).fadeIn(200); //更改正文文字
																$("#frontTextBack").html(t[0])
																		.fadeIn(200); //阴影文字
				...
				<div class="easyui-layout" data-options="fit:true">
					...
					<div data-options="region:'south',border:false"
						...
						<div style="padding: 5px; border: 1px solid #ddd">
							<a href="#" class="easyui-linkbutton" data-options="plain:false">首页</a>
							<a href="#" class="easyui-menubutton"
								data-options="menu:'#mm1',iconCls:'icon-edit',plain:false">Edit</a>
							<a href="#" class="easyui-menubutton"
								data-options="menu:'#mm2',iconCls:'icon-help',plain:false">Help</a>
							<a href="#" class="easyui-menubutton"
								data-options="menu:'#mm3',plain:false">About</a>
						</div>
						...
						<div id="mm3" class="menu-content"
							...
							<img src="http://www.jeasyui.com/images/logo1.png"
								style="width: 150px; height: 50px"> 54.
