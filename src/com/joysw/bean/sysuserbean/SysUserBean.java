...
public class SysUserBean implements java.io.Serializable {
	...
	private Set<SysDepartmentBean> sysDepartmentBeans = new HashSet<SysDepartmentBean>();
	...
	public Set<SysDepartmentBean> getSysDepartmentBeans() {
		return sysDepartmentBeans;
	}

	public void setSysDepartmentBeans(Set<SysDepartmentBean> sysDepartmentBeans) {
		this.sysDepartmentBeans = sysDepartmentBeans;
	}
	...
	/** full constructor */
	public SysUserBean(String userDepartCode, String userAccount,
